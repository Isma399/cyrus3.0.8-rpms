...
Source0: ../SOURCES/cyrus-imapd-3.0.8.tar.gz
...
BuildRequires: autoconf automake bison flex gcc gcc-c++ git 
...
BuildRequires: libnghttp2-devel libxml2-devel net-snmp-devel
BuildRequires: openldap-devel openssl-devel shapelib-devel
...
%configure \
    ...
    --with-extraident="%release Centos"\
    --with-krbimpl=mit \
    --with-ldap=/usr \
    --with-libwrap=no \
    --with-perl=%__perl \
